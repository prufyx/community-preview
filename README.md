...
The fifty-four documented scenario examples are:
...
Custodian, Crossplane, etcd, Falco, Jaeger, KEDA, Kuma, Kyverno, Prometheus, SPIRE, Strimzi, Thanos and Velero, and `prufyx check
