...
Whole-upgrade compatibility remains UNKNOWN in every case.`)
	...
	nativeProject := *project == "metallb" || *project == "contour" || *project == "kubevirt" || *project == "thanos" || *project == "cortex" || *project == "cloudnativepg" || *project == "flux" || *project == "kubernetes" || *project == "cilium" || *project == "etcd" || *project == "harbor" || *project == "fluentd" || *project == "opencost"
	...
	if (nativeFlags || flagProvided(args, "resource-scope-complete") || flagProvided(args, "distribution") || flagProvided(args, "target-api-apply-required") || ciliumNativeRequested) && !nativeProject {
		return r.usage("native resource flags require metallb, contour, kubevirt, thanos, cortex, cloudnativepg, flux, kubernetes, cilium, etcd, harbor, fluentd, or opencost; use --help")
	}
